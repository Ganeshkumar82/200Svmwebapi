...
router.post("/getorganizationlist", async function (req, res, next) { //API FUNCTION DOEST EXIST IN THE CUSTOMER SERVICE
  try {
    ...
    console.error(
      "Error while getting customer organization list",
      err.message
    );
    next(err);
  }
...
router.post("/addnewsubscription", async function (req, res, next) {
  try {
    ...
    console.error(
      "Error while adding a new subscription to the customer",
      err.message
    );
    next(err);
  }
...
router.post("/firsttimeuser", async function (req, res, next) {
  try {
    ...
    console.error(
      "Error while checking whether the customer is first time or not",
      err.message
    );
    next(err);
  }
...
router.post("/organizationcompany", async function (req, res, next) {
  try {
    ...
    console.error(
      "Error while adding a new company to the organization",
      err.message
    );
    next(err);
  }
...
router.post("/emergencyservice", async function (req, res, next) {
  try {
    ...
    console.error(
      "Error while creating customer emergency service",
      err.message
    );
  }
});
...
router.post("/addinvoice", async function (req, res, next) {
  try {
    res.json(await customer.addinvoice(req.body));
    s;
  } catch (err) {
...
router.post("/escalationcontact", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while adding customer escalation contacts`,
      err.message
    );
    next(err);
  }
...
router.post("/getescalation", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while fetching the customer escalation contacts`,
      err.message
    );
    next(err);
  }
...
router.post("/updatedevice", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while updating customer site Department device`,
      err.message
    );
    next(err);
  }
...
router.post("/paymenthistory", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while fetching the customer payment history`,
      err.message
    );
    next(err);
  }
...
router.post("/paymentinvoice", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while fetching the customer payment Invoice`,
      err.message
    );
    next(err);
  }
...
router.post("/statementaccount", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while fetching the customer statement of account`,
      err.message
    );
    next(err);
  }
...
router.post("/updatesubscription", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while updating the customer subscription`,
      err.message
    );
    next(err);
  }
...
router.delete("/device", async function (req, res, next) {
  try {
    ...
    console.error(
      `Error while while deleting the customer site Device`,
      err.message
    );
    next(err);
  }
...
router.post("/getdvrcamera", async function (req, res, next) {
  try {
    ...
    console.error(
      "Error while getting the total camera list for the company",
      err.message
    );
    next(err);
  }
...
router.get("/query", async function (req, res, next) {
  try {
    res.json(await customer.Query(req.body));
  } catch (er) {
    console.error(`Error while querying the customer `, er.message);
    next(er);
  }
});
